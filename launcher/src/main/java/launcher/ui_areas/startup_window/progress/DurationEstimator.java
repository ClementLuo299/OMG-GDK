package launcher.ui_areas.startup_window.progress;
...
public class DurationEstimator {
    ...
    public long estimateDuration(String message) {
        ...
        if (lowerMessage.contains("starting") || lowerMessage.contains("ready") || 
            lowerMessage.contains("complete") || lowerMessage.contains("ui_loading user interface")) {
        ...
        else if (lowerMessage.contains("ui_loading") || lowerMessage.contains("processing") ||
