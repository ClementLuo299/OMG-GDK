...
/**
 * Manages ui_loading animation with progress bar and animated text.
 * Also manages the refresh button state during ui_loading.
 * 
 * @author Clement Luo
...
public class LoadingAnimationManager {
     ...
     * 
     * @param refreshButton The refresh button to disable during ui_loading
     * @param loadingProgressBar The progress bar to show progress
     * @param loadingStatusLabel The status label to show ui_loading messages
     */
    ...
    /**
     * Start the ui_loading animation with animated text and progress bar.
     */
    ...
    /**
     * Get the current ui_loading task description based on animation state.
     */
    ...
    /**
     * Stop the ui_loading animation.
     */
    public void stopAnimation() {
        Logging.info("Stopping ui_loading animation");
        isRefreshing = false;
        if (refreshButton != null) {
