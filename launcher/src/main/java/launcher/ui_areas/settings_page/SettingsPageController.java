package launcher.ui_areas.settings_page;
...
public class SettingsPageController implements Initializable {
     ...
     * triggering save operations during ui_loading.
     */
    private void loadSettings() {
        ...
        if (settingsPerformanceModeToggle != null) {
            ...
            Logging.error("❌ Error ui_loading settings: " + e.getMessage(), e);
            updateStatus("Error ui_loading settings: " + e.getMessage());
        } finally {
