...
public final class FilePaths {
     ...
     */
    public static final String JSON_PERSISTENCE_FILE = "saved/gdk-json-persistence.txt";
     ...
     */
    public static final String START_MESSAGE_EXAMPLE_FILE = "saved/start-message.example.json";
    
    /**
     * Path to the local multiplayer start message file.
     * Contains the start message configuration for local multiplayer mode.
     */
    public static final String START_MESSAGE_LOCAL_MULTIPLAYER_FILE = "saved/start-message-local-multiplayer.json";
    
    /**
     * Path to the single player start message file.
     * Contains the start message configuration for single player mode.
     */
    public static final String START_MESSAGE_SINGLE_PLAYER_FILE = "saved/start-message-single-player.json";
    
    /**
     * Path to the all modes start message file.
     * Contains the start message configuration for all game modes.
     */
    public static final String START_MESSAGE_ALL_MODES_FILE = "saved/start-message-all-modes.json";
}
